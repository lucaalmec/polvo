    ...
    <body>
                ...
                <ul class="nav navbar-nav" id="link-white">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">                           
                            ...
                            <li><a href="{{route('post.index')}}">Produtos</a></li>
                        </ul>
                    </li>
                </ul>
            </div>       
        ...
        <div id="line-one">
            <div class="container">
                ...
                <div class="row">  
                    <br>
                    <h4 id="center"><b>ALTERAÇÃO CADASTRAL DE USUÁRIO</b></h4>
                    <br> 
                    <form method="post" action="{{route('user.update', $user->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">              
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{$user->name or old('name')}}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cpf" class="form-control" value="{{$user->cpf or old('cpf')}}" required>
                            </div>
                        </div>                       
                        <div class="col-md-12">                   
