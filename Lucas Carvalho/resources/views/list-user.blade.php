                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="display:none;" id="center">{{$user->id}}</td>
                                        <td title="name">{{$user->name}}</td>
                                        <td title="email">{{$user->email}}</td>
                                        <td title="cpf" id="center">{{$user->cpf}}</td>
                                        <td id="center">
                                            <a href="{{route('user.edit', $user->id)}}" title="Alterar"><i class="fa fa-pencil"></i></a>
                                            &nbsp;<form style="display: inline-block;" method="POST"action="{{route('user.destroy', $user->id)}}" data-toggle="tooltip" data-placement="top" title="Excluir" onsubmit="return confirm('Confirma exclusão?')">
